...
if __name__ == "__main__":
    ...
    for id in file_ids:
        ...
        for map in mapping:
            ...
            sam_out = "%s/%s_%03d_dmpx.sam" % (output_folder, mapping[map], id)
            bam_out = "%s/%s_%03d_dmpx_sorted" % (output_folder, mapping[map], id)
            ...
            if make_index:
                call('bwa index "%s"' % db_fasta, shell=True)
            make_index*=False
